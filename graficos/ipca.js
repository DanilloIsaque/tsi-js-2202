    ...
    return retorno.text();
      ...
      //então 
        ...
        indices.forEach( function ( mes ) {
          ...
          let anoUsuario=document.querySelector('#escolhaUsuario').value;
          if(parseInt(anoString) !=anoUsuario && 
          anoUsuario !=""){//varre o vetor inteiro, mas retorna só o ano escolhido, se vazio, ele retorna todos os anos
            return;
          }
